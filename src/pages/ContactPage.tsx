              ...
              <div className="grid md:grid-cols-3 gap-4 mb-12">
                {contactMethods.map(({ icon: Icon, label, value, href, desc }) => (
                  <a
                    ...
                    className="p-6 rounded-2xl backdrop-blur-xl bg-blue-50/80 dark:bg-white/5 border border-gray-200/40 dark:border-white/10 hover:bg-white/15 dark:hover:bg-white/10 transition-all duration-200 group"
                  >
                ...
                >
                  <div className="grid sm:grid-cols-2 gap-4">
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-xl backdrop-blur-xl bg-blue-50/80 dark:bg-white/5 border border-gray-200/40 dark:border-white/10 outline-none focus:border-[var(--accent)] transition-colors text-sm"
                    />
                    <input
                      type="email"
                      name="email"
                  ...
                  <textarea
                    ...
                    rows={5}
                    required
                    className="w-full px-4 py-3 rounded-xl backdrop-blur-xl bg-blue-50/80 dark:bg-white/5 border border-gray-200/40 dark:border-white/10 outline-none focus:border-[var(--accent)] transition-colors text-sm resize-none"
                  />
                  <button
                    type="submit"
