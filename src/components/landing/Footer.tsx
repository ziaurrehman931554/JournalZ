          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="p-2.5 rounded-xl backdrop-blur-xl bg-blue-50/80 dark:bg-white/5 border border-gray-200/40 dark:border-white/10 hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-200"
              >
