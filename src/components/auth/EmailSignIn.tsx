    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="relative">
        ...
        <input
          ...
          required
          className="w-full pl-10 pr-4 py-3 rounded-xl backdrop-blur-xl bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 outline-none focus:border-[var(--accent)] transition-colors"
        />
      </div>
      <div className="relative">
        ...
        <input
          ...
          required
          minLength={6}
          className="w-full pl-10 pr-10 py-3 rounded-xl backdrop-blur-xl bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 outline-none focus:border-[var(--accent)] transition-colors"
        />
        <button
          type="button"
